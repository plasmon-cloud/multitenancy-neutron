...
module {
    // Stable multitenancy-neutron tenant -> assigned physical app instance ids.
    //
    ...
    // The root identity and this v1 layout are upgrade-sensitive once
    // multitenancy-neutron promises compatibility with deployed state.
    public type Mem = {
